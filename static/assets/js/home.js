...
// Splash texts
const SplashT = [
  "Unblocking since 2024",
  "Fastest growing proxy server",
  "Made by Solidwild",
  "BiaSuli's most trusted unblocker :)",
  "Thanks for using the site!",
  "Follow me on Tiktok (@solidwild)",
  "Subscribe to my YouTube (@solidwild)",
  "Check my links at yoursit.ee/solidwild :)",
